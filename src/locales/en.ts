export default {
  ...
  presets: {
    delta: 'Delta',
    deltaDesc: '(Deep Sleep)',
    theta: 'Theta',
    thetaDesc: '(Meditation)',
    alpha: 'Alpha',
    alphaDesc: '(Relaxation)',
    beta: 'Beta',
    betaDesc: '(Focus)',
    gamma: 'Gamma',
    gammaDesc: '(Cognition)',
  ...
  sounds: {
    ...
    field: 'Field', lake: 'Lake', 'summer-night-bugs': 'Summer Night Bugs', 'eating-chips': 'Eating Chips', piano: 'Piano', study: 'Study', kitchen: 'Kitchen', drizzle: 'Drizzle', 'heavy-rain-on-glass': 'Heavy Rain on Glass', 'heavy-rain-2': 'Heavy Rain 2', 'rain-on-eaves-2': 'Rain on Eaves 2', 'rain-on-eaves': 'Rain on Eaves', 'rain-on-empty-street': 'Rain on Empty Street', 'rain-on-raincoat': 'Rain on Raincoat', 'rain-on-windowsill': 'Rain on Windowsill', 'rain-on-wooden-house': 'Rain on Wooden House', 'rain-while-driving': 'Rain while Driving', thunderstorm: 'Thunderstorm', 'windy-drizzle': 'Windy Drizzle', 'trickling-rain': 'Trickling Rain', 'bright-rain': 'Bright Rain', 'rain-on-canopy': 'Rain on Canopy', 'rain-on-roof': 'Rain on Roof', 'ear-cleaning-1': 'Ear Cleaning 1', 'ear-cleaning-2': 'Ear Cleaning 2', guitar: 'Guitar', guzheng: 'Guzheng', 'light-piano': 'Light Piano', 'elegant-piano': 'Elegant Piano', 'meditation-zither': 'Meditation Zither', 'daze-sound': 'Daze Sound', 'fan-2': 'Fan 2'
  },
  menu: {
