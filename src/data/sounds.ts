...
export const nature: Category = {
  ...
  sounds: [
    ...
    { icon: 'Trees', id: 'field', label: 'Field', src: getAssetPath('/sounds/nature/field.ogg') },
    { icon: 'Droplets', id: 'lake', label: 'Lake', src: getAssetPath('/sounds/nature/lake.ogg') },
    { icon: 'Bug', id: 'summer-night-bugs', label: 'Summer Night Bugs', src: getAssetPath('/sounds/nature/夏夜虫鸣.ogg') },
  ],
  title: 'Nature',
};
...
export const rain: Category = {
  ...
  sounds: [
    ...
    { icon: 'CloudRain', id: 'drizzle', label: 'Drizzle', src: getAssetPath('/sounds/rain/drizzle.ogg') },
    { icon: 'CloudRain', id: 'heavy-rain-on-glass', label: 'Heavy Rain on Glass', src: getAssetPath('/sounds/rain/heavy-rain-on-glass.ogg') },
    { icon: 'CloudRain', id: 'heavy-rain-2', label: 'Heavy Rain 2', src: getAssetPath('/sounds/rain/heavy_rain.ogg') },
    { icon: 'CloudRain', id: 'rain-on-eaves-2', label: 'Rain on Eaves 2', src: getAssetPath('/sounds/rain/屋檐落雨.ogg') },
    { icon: 'CloudRain', id: 'rain-on-eaves', label: 'Rain on Eaves', src: getAssetPath('/sounds/rain/rain-on-eaves.ogg') },
    { icon: 'CloudRain', id: 'rain-on-empty-street', label: 'Rain on Empty Street', src: getAssetPath('/sounds/rain/rain-on-empty-street.ogg') },
    { icon: 'CloudRain', id: 'rain-on-raincoat', label: 'Rain on Raincoat', src: getAssetPath('/sounds/rain/rain-on-raincoat.ogg') },
    { icon: 'CloudRain', id: 'rain-on-windowsill', label: 'Rain on Windowsill', src: getAssetPath('/sounds/rain/rain-on-windowsill.ogg') },
    { icon: 'CloudRain', id: 'rain-on-wooden-house', label: 'Rain on Wooden House', src: getAssetPath('/sounds/rain/rain-on-wooden-house.ogg') },
    { icon: 'CloudRain', id: 'rain-while-driving', label: 'Rain while Driving', src: getAssetPath('/sounds/rain/rain-while-driving.ogg') },
    { icon: 'CloudLightning', id: 'thunderstorm', label: 'Thunderstorm', src: getAssetPath('/sounds/rain/thunderstorm.ogg') },
    { icon: 'Wind', id: 'windy-drizzle', label: 'Windy Drizzle', src: getAssetPath('/sounds/rain/小雨加风.ogg') },
    { icon: 'CloudRain', id: 'trickling-rain', label: 'Trickling Rain', src: getAssetPath('/sounds/rain/尖尖流雨.ogg') },
    { icon: 'CloudRain', id: 'bright-rain', label: 'Bright Rain', src: getAssetPath('/sounds/rain/敞亮雨.ogg') },
    { icon: 'CloudRain', id: 'rain-on-canopy', label: 'Rain on Canopy', src: getAssetPath('/sounds/rain/雨棚.ogg') },
    { icon: 'CloudRain', id: 'rain-on-roof', label: 'Rain on Roof', src: getAssetPath('/sounds/rain/顶棚雨.ogg') },
  ],
  title: 'Rain',
};
...
export const places: Category = {
  ...
  sounds: [
    ...
    { icon: 'Utensils', id: 'kitchen', label: 'Kitchen', src: getAssetPath('/sounds/places/kitchen.ogg') },
  ],
  title: 'Places',
};
...
export const things: Category = {
  ...
  sounds: [
    ...
    { icon: 'Heart', id: 'ear-cleaning-1', label: 'Ear Cleaning 1', src: getAssetPath('/sounds/things/ear-cleaning-1.ogg') },
    { icon: 'Heart', id: 'ear-cleaning-2', label: 'Ear Cleaning 2', src: getAssetPath('/sounds/things/ear-cleaning-2.ogg') },
    { icon: 'Disc', id: 'guitar', label: 'Guitar', src: getAssetPath('/sounds/things/guitar.ogg') },
    { icon: 'Disc', id: 'guzheng', label: 'Guzheng', src: getAssetPath('/sounds/things/guzheng.ogg') },
    { icon: 'Disc', id: 'light-piano', label: 'Light Piano', src: getAssetPath('/sounds/things/light-piano.ogg') },
    { icon: 'Disc', id: 'elegant-piano', label: 'Elegant Piano', src: getAssetPath('/sounds/things/优雅钢琴.ogg') },
    { icon: 'Disc', id: 'meditation-zither', label: 'Meditation Zither', src: getAssetPath('/sounds/things/冥想琴音.ogg') },
    { icon: 'Disc', id: 'daze-sound', label: 'Daze Sound', src: getAssetPath('/sounds/things/发呆音.ogg') },
    { icon: 'Wind', id: 'fan-2', label: 'Fan 2', src: getAssetPath('/sounds/things/风扇.ogg') },
  ],
  title: 'Things',
};
...
export const noise: Category = {
  ...
  sounds: [
    ...
    { icon: 'Utensils', id: 'eating-chips', label: 'Eating Chips', src: getAssetPath('/sounds/noise/eating-chips.ogg') },
    { icon: 'Disc', id: 'piano', label: 'Piano', src: getAssetPath('/sounds/noise/piano.ogg') },
    { icon: 'Library', id: 'study', label: 'Study', src: getAssetPath('/sounds/noise/study.ogg') },
  ],
  title: 'Noise',
};
